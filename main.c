...
int main(void)
{
  ...
  osThreadDef(LED_TASK, StartDefaultTask, osPriorityLow, 0, 128);
  LED_TASKHandle = osThreadCreate(osThread(LED_TASK), NULL);

  /* definition and creation of UART_TASK */
  osThreadDef(UART_TASK, StartTask02, osPriorityHigh, 0, 256);
  UART_TASKHandle = osThreadCreate(osThread(UART_TASK), NULL);

  /* definition and creation of MONITOR_TASK */
  osThreadDef(MONITOR_TASK, StartTask03, osPriorityNormal, 0, 128);
